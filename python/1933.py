...
a = input().split() #split the inputs to a[0], ..., as str format
a = ([int(x) for x in a]) #converts all elements of a to int
if 1<=a[0]<=13 and 1<=a[1]<=13:
    print(tri_du(int(a[0]),int(a[1])))
